...
class DataService {
    ...
    func getCollaborationGroups() -> [CollaborationGroup] {
        var groups = [
            CollaborationGroup(
                name: "Spanish Learners Unite",
                description: "Practice Spanish conversation and help each other learn",
                category: .language,
            ...
            CollaborationGroup(
                ...
                description: "Solve algebra problems together and share tips",
                category: .mathematics,
                createdBy: "Alex Chen",
                maxMembers: 8
            ),
            ...
            CollaborationGroup(
                ...
                description: "Share artwork, get feedback, and learn color theory",
                category: .arts,
        ...
        for i in 0..<groups.count {
            groups[i].members = [
                GroupMember(name: groups[i].createdBy, avatarColor: "#fbd600"),
                GroupMember(name: "John Smith", avatarColor: "#ffffff"),
                GroupMember(name: "Lisa Wang", avatarColor: "#fbd600")
            ]
            
            groups[i].messages = [
                GroupMessage(
                    senderId: UUID(),
                    senderName: groups[i].createdBy,
                    content: "Welcome everyone! Let's help each other learn and grow."
                ),
                GroupMessage(
                    senderId: UUID(),
                    senderName: "John Smith",
                    content: "Excited to be here! Looking forward to learning with you all."
                ),
                GroupMessage(
                    senderId: UUID(),
                    senderName: "Lisa Wang",
                    content: "Has anyone completed today's challenge yet?"
                )
            ]
        }
